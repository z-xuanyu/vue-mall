    ...
    <div class="has-goods-order" v-else>
      ...
      <div class="card-goods-list" v-for="(item,shopIdex) in cartInfoList" :key="item.id">
        ...
        <div class="van-hairline--bottom store">
          <van-row>
            <van-col>
              <van-checkbox v-model="item.checkedShop" @click="checkShop(item,shopIdex)" />
            </van-col>
            <van-col>
              <van-image
                width="20"
                height="20"
                lazy-load
                src="http://t16img.yangkeduo.com/pdd_ims/77b95bab6fb53e3ac4cc370ba6a48d5a.jpg"
                type="contain"
              />
            </van-col>
          ...
          <div slot="default" class="order-item">
            <van-row type="flex" justify="space-between">
              ...
              <van-col span="3" class="d-flex-c">
                <van-checkbox v-model="pros.isSelected" @click="selectSingle(item,pros,shopIdex,index)"></van-checkbox>
              </van-col>
              <!-- 订单商品图片 -->
              <van-col span="6">
                <van-image
...
export default {
  ...
  methods: {
    ...
    // 商品单选
    selectSingle(item,pros, shopIdex,index) {
      console.log(item);
      console.log(pros)
      console.log(shopIdex)
      console.log(index)
      this.cartInfoList[shopIdex].checkedShop = pros.isSelected
      console.log(pros.isSelected)
    }
  },
  watch: {
